...
uint256 hashGenesisBlock("0x93788de951668087e91fa50a3e768460e303648ce4ea303431c9928333fda472");
...
{
    int64 nSubsidy = 3.14159265359 * COIN;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // PiCoin: 1 days
static const int64 nTargetSpacing = 188.4; // PiCoin: 3.14 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x9966a29e681d2d80de4b724f2343ecd880ff12c52cea1774f24345e9be5e4556");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Manning wants to be a woman.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1377213704; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 96908;

        if (fTestNet)
        {
            block.nTime    = 1377206897;
            block.nNonce   = 299705;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x659d98dbb1466e851abcce4c9c11ebb0ce6fda2ce92ded9748a75fcb625cdaa9"));
